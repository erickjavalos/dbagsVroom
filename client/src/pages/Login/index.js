    ...
    return (
        <>
            <div className="flex items-center justify-center h-screen bg-discord-gray">
                ...
                <a
                    id="login"
                    href="https://discord.com/api/oauth2/authorize?client_id=1106720134615289937&redirect_uri=http%3A%2F%2Flocalhost%3A3001%2Fauth&response_type=code&scope=identify%20guilds%20email"
